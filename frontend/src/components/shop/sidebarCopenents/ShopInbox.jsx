...
//   useEffect(() => {
//     if (item && item.member) {
//       const userId = item.member.find((user) => user !== seller);

//       const getUser = async () => {
//         try {
//           const res = await axios.get(`${server}/user/user/${userId}`);
//           setUserData(res.item.user);
//         } catch (error) {
//           console.log(error);
//         }
//       };
...
// Please import necessary dependencies and styles as needed.
